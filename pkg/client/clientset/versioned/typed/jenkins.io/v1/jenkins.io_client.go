...
import (
	...
	"github.com/jenkins-x/sso-operator/pkg/client/clientset/versioned/scheme"
...
func (c *JenkinsV1Client) SSOs(namespace string) SSOInterface {
	return newSSOs(c, namespace)
}
